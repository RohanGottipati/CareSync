                ...
                <div className="max-w-3xl mx-auto text-center">
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0}>
                        ...
                        <p className="text-gray-500 text-lg leading-relaxed max-w-2xl mx-auto">
                            WardRound gives Personal Support Workers intelligent pre-visit briefings,
            ...
            >
                ...
                >
                    ...
                    <p className="text-blue-100 text-base leading-relaxed">
                        WardRound is the care coordination platform that Canadian home-care
                ...
                <div style={{
                    ...
                    WardRound &copy; {new Date().getFullYear()} &middot; Built for Vultr Hackathon
                </div>
            </section>
        </div>
    );
